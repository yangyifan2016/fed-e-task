...
;
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js"}],"node_modules/snabbdom/build/package/modules/eventlisteners.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/snabbdom/build/package/modules/dataset.js":[function(require,module,exports) {
"use strict";
...
var patch = (0, _init.init)([_eventlisteners.eventListenersModule, _dataset.datasetModule]);
var data = [{
  rank: 1,
  name: 'first',
  desc: 'gXXXX'
...
var title = (0, _h.h)('h1', 'Top 10 movies');
var rankButton = (0, _h.h)('a.padding-right.pointer', {
  on: {
...
var titleButton = (0, _h.h)('a.padding-right.pointer', {
  on: {
    click: function click() {
      data.sort(function (a, b) {
...
var descButton = (0, _h.h)('a.padding-right.pointer', {
  on: {
    click: function click() {
      data.sort(function (a, b) {
...
var sortLabel = (0, _h.h)('span.padding-right', 'Sort by:');
var sortsContainer = (0, _h.h)('div.inline-block', [rankButton, titleButton, descButton]);
var addButton = (0, _h.h)('a.pointer.fr', {
  on: {
    click: function click() {
      var rank = 0;
...
var buttonsContainer = (0, _h.h)('div', [sortLabel, sortsContainer, addButton]);
var vnode = view(data);
...
function view(data) {
  ...
  data.forEach(function (movie) {
    lis.push((0, _h.h)('li.movie', [(0, _h.h)('span', movie.rank), (0, _h.h)('span', movie.name), (0, _h.h)('span', movie.desc), (0, _h.h)('a.pointer', {
      dataset: {
        rank: movie.rank
      },
      on: {
  ...
  var ul = (0, _h.h)('ul', lis);
  return (0, _h.h)('div.container', [title, buttonsContainer, ul]);
}
},{"snabbdom/build/package/init":"node_modules/snabbdom/build/package/init.js","snabbdom/build/package/h":"node_modules/snabbdom/build/package/h.js","snabbdom/build/package/modules/eventlisteners":"node_modules/snabbdom/build/package/modules/eventlisteners.js","snabbdom/build/package/modules/dataset":"node_modules/snabbdom/build/package/modules/dataset.js"}],"node_modules/_parcel-bundler@1.12.4@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
